...
I0 outputs are `requirements-traceability.md`, `api-contract.md`, and `payment-lifecycle.md`, together with the approval record in `open-decisions.md`. The user approved the scope and policies on 2026-09-24; the neutral public repository and `main` protection are now in place. Complete the I0 feature PR before starting I1. CI checks are configured in I1, not retrofitted as a false I0 gate.
