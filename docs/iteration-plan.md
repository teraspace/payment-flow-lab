...
I0 outputs are `requirements-traceability.md`, `api-contract.md`, and `payment-lifecycle.md`, together with the decisions in `open-decisions.md`. I0 is ready for the user's approval; it is not accepted until that validation and the public GitHub gate are complete. Do not start I1 before the user validates the I0 scope/lifecycle and publication.
