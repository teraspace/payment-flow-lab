...
Still open for later contract refinement: user-facing cancellation control, unresolved-attempt escalation threshold, and webhook receipt retention. Resolve each before the iteration that depends on it and record any approval or revision.
